...
namespace Vars
{
	...
	NAMESPACE_BEGIN(Colors)
		...
		CVar(HealthBarStatic, "Health bar static color", Color_t(255, 255, 255, 255), VISUAL);
	...
	NAMESPACE_BEGIN(ESP)
		...
		CVarEnum(Player, VA_LIST("Player", "Player ESP"), 0b0, VISUAL | DROPDOWN_MULTI, nullptr,
			VA_LIST("Enemy", "Team", "Local", "Prioritized", "Friends", "Party", "##Divider", "Name", "Name background", "Box", "Distance", "Bones", "Health bar", "Health bar background", "Health bar no border", "Health bar color by health", "Health bar static color", "Health text", "Uber bar", "Uber text", "Class icon", "Class text", "Weapon icon", "Weapon text", "Priority", "Labels", "Buffs", "Debuffs", "Misc", "Lag compensation", "Ping", "KDR", "That's how mafia works"),
			Enemy = 1 << 0, Team = 1 << 1, Local = 1 << 2, Prioritized = 1 << 3, Friends = 1 << 4, Party = 1 << 5, Name = 1 << 6, NameBackground = 1 << 7, Box = 1 << 8, Distance = 1 << 9, Bones = 1 << 10, HealthBar = 1 << 11, HealthBarBackground = 1 << 12, HealthBarNoBorder = 1 << 13, HealthBarColorByHealth = 1 << 14, HealthBarStaticColor = 1 << 15, HealthText = 1 << 16, UberBar = 1 << 17, UberText = 1 << 18, ClassIcon = 1 << 19, ClassText = 1 << 20, WeaponIcon = 1 << 21, WeaponText = 1 << 22, Priority = 1 << 23, Labels = 1 << 24, Buffs = 1 << 25, Debuffs = 1 << 26, Misc = 1 << 27, LagCompensation = 1 << 28, Ping = 1 << 29, KDR = 1 << 30, ThatsHowMafiaWorks = 1 << 31);
		CVarEnum(Building, VA_LIST("Building", "Building ESP"), 0b0, VISUAL | DROPDOWN_MULTI, nullptr,
			VA_LIST("Enemy", "Team", "Local", "Prioritized", "Friends", "Party", "##Divider", "Name", "Name background", "Box", "Distance", "Health bar", "Health bar background", "Health bar no border", "Health bar color by health", "Health bar static color", "Health text", "Owner", "Level", "Flags"),
			Enemy = 1 << 0, Team = 1 << 1, Local = 1 << 2, Prioritized = 1 << 3, Friends = 1 << 4, Party = 1 << 5, Name = 1 << 6, NameBackground = 1 << 7, Box = 1 << 8, Distance = 1 << 9, HealthBar = 1 << 10, HealthBarBackground = 1 << 11, HealthBarNoBorder = 1 << 12, HealthBarColorByHealth = 1 << 13, HealthBarStaticColor = 1 << 14, HealthText = 1 << 15, Owner = 1 << 16, Level = 1 << 17, Flags = 1 << 18);
		...
		CVar(Dist2Alpha, "Distance to alpha", true, VISUAL);
